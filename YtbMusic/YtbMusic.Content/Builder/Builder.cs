...
// El builder se encuentra en: YtbMusic/YtbMusic.Content/Builder/
// Y YtbMusic.Core está en: YtbMusic/YtbMusic.Core/
string currentDirectory = AppContext.BaseDirectory;
string platformsCoreDirectory = Path.GetFullPath(Path.Combine(currentDirectory, "..", "..", "..", "..", "YtbMusic.Core"));
...
{
    platformsCoreDirectory = Path.GetFullPath(Path.Combine(Directory.GetCurrentDirectory(), "..", "YtbMusic.Core"));
}
...
if (!Directory.Exists(platformsCoreDirectory))
{
    ...
    while (!string.IsNullOrEmpty(projectRoot) && !Directory.Exists(Path.Combine(projectRoot, "YtbMusic", "YtbMusic.Core")))
    {
        projectRoot = Path.GetDirectoryName(projectRoot);
    }
    if (!string.IsNullOrEmpty(projectRoot))
    {
        platformsCoreDirectory = Path.Combine(projectRoot, "YtbMusic", "YtbMusic.Core");
    }
}
...
Console.WriteLine($"[Builder] Using YtbMusic.Core directory: {platformsCoreDirectory}");
